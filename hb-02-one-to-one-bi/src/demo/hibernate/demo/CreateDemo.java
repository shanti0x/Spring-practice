...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            //creez ob
			Instructor tempInstructor=new Instructor("Dana", "Maria", "aaa@gmail.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.youtube.com", "Love two code");
